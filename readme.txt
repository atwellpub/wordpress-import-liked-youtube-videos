...
Donate link: mailto:hudson@paypal.com
...
* Adding option to set post author
* Finally fixing the issue with iframes being stripped out during cronjob runs
 
= 1.0.7 =

* Adding history section to settings area. 
